...
var CodeBlockPlugin = class extends import_obsidian.Plugin {
  onload() {
  ...
  static addCodeBlock(language, selection) {
    return "```" + language + "\n" + selection + "\n```\n";
  }
  getLanguage(selection) {
...
var CodeBlockTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    hljs.listLanguages().sort().forEach((language) => {
      ...
      return new import_obsidian.Setting(containerEl).setName(language).addToggle((toggle) => toggle.setValue(active).onChange(() => __async(this, null, function* () {
        if (active) {
