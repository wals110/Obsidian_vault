...
- Category: #articles
- Summary: Reader centralizes web articles, PDFs, ebooks, RSS, newsletters, and YouTube so you can save and read everything in one place.  
It’s built for power users with keyboard shortcuts, browser and mobile highlighters, image and video highlighting, and text-to-speech.  
Library vs Feed organizes content, highlights sync to Readwise, and the app is updated often based on user feedback.
